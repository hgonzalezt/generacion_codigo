...
public class MaquinaControllerTest {
  ...
  @MockBean private MaquinaService maquinaService;
  ...
  void testGetAllMaquinas() throws Exception {
    ...
    mockMvc
        .perform(get("/api/maquinas").contentType(MediaType.APPLICATION_JSON))
  ...
  void testGetMaquinaById() throws Exception {
    ...
    mockMvc
        .perform(get("/api/maquinas/" + id).contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
  ...
  void testDeleteMaquina() throws Exception {
    ...
    mockMvc.perform(delete("/api/maquinas/" + id)).andExpect(status().isOk());
  }
}
